...
class VimeoTest < Test::Unit::TestCase
  def test_transform_url_with_www
    ...
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&byline=0&portrait=0" width="440" height="248" frameborder="0" allowfullscreen></iframe>', result
  end
  ...
  def test_transform_with_options
    ...
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&byline=0&portrait=0" width="300" height="250" frameborder="0" allowfullscreen></iframe>', result
  end

  def test_transform_with_title
    result = auto_html("http://www.vimeo.com/3300155") { vimeo(width: 300, height: 250, show_title: true) }
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?byline=0&portrait=0" width="300" height="250" frameborder="0" allowfullscreen></iframe>', result
  end

  def test_transform_with_byline
    result = auto_html("http://www.vimeo.com/3300155") { vimeo(width: 300, height: 250, show_byline: true) }
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&portrait=0" width="300" height="250" frameborder="0" allowfullscreen></iframe>', result
  end
  ...
  def test_transform_with_portrait
    ...
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&byline=0" width="300" height="250" frameborder="0" allowfullscreen></iframe>', result
  end
  ...
  def test_transform_embed_url
    result = auto_html('https://player.vimeo.com/video/3300155/fallback?js') { vimeo }
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&byline=0&portrait=0" width="440" height="248" frameborder="0" allowfullscreen></iframe>', result
  end
end
