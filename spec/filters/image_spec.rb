...
RSpec.describe AutoHtml::Image do
  it 'transforms an image link to image tag' do
    ...
    expect(result).to eq('<img src="http://rors.org/images/rails.png" alt="" />')
  end
  ...
  it 'transforms image link with a param to image tag' do
    ...
    expect(result).to eq('<img src="http://farm4.static.flickr.com/3664/3512431377_71b8d002ef.jpg?v=0" alt="" />')
  end
  ...
  it 'transforms image link on https to image tag' do
    ...
    expect(result).to eq('<img src="https://img.skitch.com/20100910-1wrbg5749xe29ya5t3s85bnaiy.png" alt="" />')
  end
  ...
  it 'transforms image link to a image tag with proxy as source' do
    ...
    expect(result).to eq('<img src="https://proxy/?url=http://img.skitch.com/20100910-1wrbg5749xe29ya5t3s85bnaiy.png" alt="" />')
  end

  it 'does not transforms already transformed image' do
    result = subject.call('<img src="http://farm4.static.flickr.com/3459/3270173112_5099d3d730.jpg" alt="" />')
    expect(result).to eq('<img src="http://farm4.static.flickr.com/3459/3270173112_5099d3d730.jpg" alt="" />')
  end
  ...
  it 'transforms an image link within text to image tag' do
    ...
    expect(result).to eq('Which do you prefer, this one <img src="http://www.lockhartfineart.com/images/Rio_Grande_Frost.JPG" alt="" />, or this one <img src="http://rors.org/images/rails.png" alt="" />?')
  end
  ...
  it 'transforms an image link with a lot of param to image tag' do
    ...
    expect(result).to eq('<img src="http://tbn3.google.com/images?q=tbn:vS-jtEi9Xc8K6M:http://upload.wikimedia.org/wikipedia/commons/b/ba/Potturinn.jpeg" alt="" />')
  end
end
